...
- Not yet decided (proposed, awaiting Mitch): experiment queue, failure log, taster profiles, photo gallery, Year in Bakes, bake-day mode. Also pending: bake photo storage, single-user auth (build before real data accumulates).
